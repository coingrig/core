...
export const CUSD_ADDRESS_TESTNET =
  '0x874069fa1eb16d44d622f2e0ca25eea172369bc1';
export const CEUR_ADDRESS_MAINNET =
  '0xd8763cba276a3738e6de85b4b3bf5fded6d6ca73';
export const CEUR_ADDRESS_TESTNET =
...
export const CELO_BASED_CURRENCIES = [
  Currency.CELO.toString(),
  Currency.CEUR.toString(),
  Currency.CUSD.toString(),
];
